...
;(function ($, document, window, undefined) {
			...
			for (var i = 0; i < length; i++) {
				...
				if (instance[el].options.showThumb === true) {
					...
					if (instance[el].options.multiUpload === false) {
						row = '<tr class="fileupload-previewrow thumb" id="' + fileName + '"><td class="col-lg-1">' + thumb + '</td><td class="col-lg-4">' + file.name + '</td><td class="col-lg-1">' + sizeDisplay + '</td><td class="col-lg-5">' + progressBar + '</td><td class="col-lg-1"><button class="btn btn-primary fileupload-remove" value="' + fileName + '"><i class="fa fa-trash-o m-0"></i></button></td></tr>';
					} else {
						row = '<tr class="fileupload-previewrow thumb" id="' + fileName + '"><td class="col-lg-1">' + thumb + '</td><td class="col-lg-8">' + file.name + '</td><td class="col-lg-1">' + sizeDisplay + '</td><td class="col-lg-2"><button class="btn btn-primary fileupload-remove" value="' + fileName + '"><i class="fa fa-trash-o m-0"></i></button></td></tr>';
					}
				} else {
					if (instance[el].options.multiUpload === false) {
						row = '<tr class="fileupload-previewrow no-thumb" id="' + fileName + '"><td class="col-lg-5">' + file.name + '</td><td class="col-lg-1">' + sizeDisplay + '</td><td class="col-lg-5">' + progressBar + '</td><td class="col-lg-1"><button class="btn btn-primary fileupload-remove" value="' + fileName + '"><i class="fa fa-trash-o m-0"></i></button></td></tr>';
					} else {
						row = '<tr class="fileupload-previewrow no-thumb" id="' + fileName + '"><td class="col-lg-9">' + file.name + '</td><td class="col-lg-1">' + sizeDisplay + '</td><td class="col-lg-2"><button class="btn btn-primary fileupload-remove" value="' + fileName + '"><i class="fa  fa-trash-o m-0"></i></button></td></tr>';
					}
				}
	...
	function formStructure (el) {
		...
		instance[el].btnAdd = $('<div class="fileupload-add"><input type="file" ' + (instance[el].options.multiFile === true ? 'multiple="multiple"' : void 0) + 'multiple />Drag and Drop your File here&hellip;</div>');
		instance[el].btnReset = $('<button type="reset" class="btn btn-primary fileupload-reset"><i class="fa fa-repeat"></i>&nbsp;Add More Files&hellip;</button>');
		instance[el].btnStart = $('<button class="btn btn-blue fileupload-start"><span>Start upload</span></button>');
		instance[el].btnCancel = $('<button type="reset" class="btn btn-primary fileupload-cancel"><span>Cancel upload</span></button>');
	...
	function fallbackFormStructure (el) {
		...
		instance[el].btnAdd = $('<div class="input-group"><span class="input-group-btn"><span class="btn btn-success fileupload-fallback-add"><i class="fa fa-plus"></i>&nbsp;Add Files&hellip; <input type="file" name="' + instance[el].options.inputName + '" ' + (instance[el].options.multiFile === true ? 'multiple="multiple"' : void 0) + '></span></span><input type="text" class="form-control" readonly></div>');
		instance[el].btnStart = $('<div class="form-group"><button type="submit" class="btn btn-warning fileupload-fallback-start"><i class="fa fa-upload"></i>&nbsp;<span>Start upload</span></button><button type="reset" class="btn btn-primary fileupload-fallback-reset"><i class="fa fa-repeat"></i>&nbsp;Reset</button></div>');
